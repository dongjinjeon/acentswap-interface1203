...
import { Currency, currencyEquals, ETHER, Percent, WETH } from 'acentswap-sdk-bsc'
...
export default function RemoveLiquidity({
  ...
  function modalBottom() {
    ...
    const newLocal = <Button disabled={!(approval === ApprovalState.APPROVED || signatureData !== null)} onClick={onRemove}>
          ...
          <TransactionConfirmationModal
            ...
            content={() => (
              <ConfirmationModalContent
                ...
                onDismiss={handleDismissConfirmation}
                topContent={modalHeader} // eslint-disable-line
                bottomContent={modalBottom} // eslint-disable-line
              />
            )}
            ...
            <Body style={{ paddingBottom: '24px' }}>
              ...
              <div style={{ position: 'relative' }}>
                {!account ? (
                  ...
                  <RowBetween>
                    <Button
                      onClick={onAttemptToApprove}// eslint-disable-line
